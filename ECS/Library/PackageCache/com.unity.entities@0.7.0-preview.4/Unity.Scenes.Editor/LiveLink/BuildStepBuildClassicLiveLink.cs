...
namespace Unity.Scenes.Editor
{
    ...
    [FormerlySerializedAs("Unity.Platforms.Build.Classic.BuildStepBuildClassicLiveLink, Unity.Platforms.Build.Classic")]
    sealed class BuildStepBuildClassicLiveLink : BuildStep
    {
        ...
        public override BuildStepResult RunBuildStep(BuildContext context)
        {
            ...
            var settings = Platforms.Build.Internals.BuildContextInternals.GetBuildConfiguration(context);
