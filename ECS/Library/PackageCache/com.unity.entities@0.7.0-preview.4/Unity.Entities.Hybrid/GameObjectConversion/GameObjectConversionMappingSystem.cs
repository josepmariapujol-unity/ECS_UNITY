...
namespace Unity.Entities.Conversion
{
    ...
    class GameObjectConversionMappingSystem : ComponentSystem
    {
...
#if UNITY_EDITOR
        public T GetBuildConfigurationComponent<T>() where T : Platforms.Build.IBuildComponent
        {
        ...
        public bool TryGetBuildConfigurationComponent<T>(out T component) where T : Platforms.Build.IBuildComponent
        {
            if (m_Settings.BuildConfiguration == null || !m_Settings.BuildConfiguration)
            {
                component = default;
