...
{
    internal static int* GetManagedComponentIndex(this EntityDataAccess dataAccess, Entity entity, int typeIndex)
    {
        dataAccess.EntityComponentStore->AssertEntityHasComponent(entity, typeIndex);

        if (dataAccess.IsMainThread)
            dataAccess.EntityManager.DependencyManager->CompleteReadAndWriteDependency(typeIndex);
    ...
    public static T GetComponentData<T>(this EntityDataAccess dataAccess, Entity entity) where T : class, IComponentData
    {
        var typeIndex = TypeManager.GetTypeIndex<T>();
    ...
    public static T GetComponentObject<T>(this EntityDataAccess dataAccess, Entity entity, ComponentType componentType)
    {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
    ...
    public static void SetComponentObject(this EntityDataAccess dataAccess, Entity entity, ComponentType componentType, object componentObject)
    {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
        if (!componentType.IsManagedComponent)
